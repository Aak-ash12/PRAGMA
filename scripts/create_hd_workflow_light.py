...
<head>
<meta charset="UTF-8">
<title>PRAGMA — Module Workflow (Light)</title>
<style>
  ...
  * {
  ...
  /* Specific color themes matching the CareSphere PDF diagram colors */
  .color-blue {
    background-color: #EBF3FB;
    border: 1.5px solid #4A85C5;
    color: #1E3A8A;
  }
  .color-blue .node-desc { color: #3B5998; }

  .color-green {
    background-color: #EEF7F2;
    border: 1.5px solid #56A57B;
    color: #065F46;
  }
  .color-green .node-desc { color: #047857; }

  .color-yellow {
    background-color: #FEF8E7;
    border: 1.5px solid #D9A74E;
    color: #92400E;
  }
  .color-yellow .node-desc { color: #B45309; }

  .color-purple {
    background-color: #F5EEF8;
    border: 1.5px solid #9A5EB8;
    color: #6B21A8;
  }
  .color-purple .node-desc { color: #7E22CE; }

  .color-pink {
    background-color: #FDEDF0;
    border: 1.5px solid #C9526D;
    color: #9D174D;
  }
  .color-pink .node-desc { color: #BE185D; }
  ...
  .color-orange .node-desc { color: #9A3412; }
...
<body>
  <div class="canvas">
    ...
    <!-- Connection Labels -->
    <div class="conn-label" style="left: 310px; top: 672px; color: #15803d;">Websocket Active</div>
    <div class="conn-label" style="left: 560px; top: 672px; color: #b91c1c;">Websocket Offline / Poor</div>
...
html_path = r"c:\Users\aakas\OneDrive\Desktop\PRAGMA\workflow_hd_light.html"
...
output_png = r"c:\Users\aakas\OneDrive\Desktop\PRAGMA\pragma_workflow_hd_light.png"
