...
<head>
<meta charset="UTF-8">
<title>PRAGMA — Workflow Summary (Dark)</title>
<style>
  ...
  * {
  ...
  .circle-blue { border: 2px solid #3B82F6; color: #60A5FA; }
  .circle-purple { border: 2px solid #A855F7; color: #C084FC; }
  .circle-green { border: 2px solid #10B981; color: #34D399; }
  .circle-yellow { border: 2px solid #F59E0B; color: #FBBF24; }
  .circle-red { border: 2px solid #EF4444; color: #F87171; }
...
html_path = r"c:\Users\aakas\OneDrive\Desktop\PRAGMA\workflow_summary_hd.html"
...
output_png = r"c:\Users\aakas\OneDrive\Desktop\PRAGMA\pragma_workflow_summary_hd.png"
